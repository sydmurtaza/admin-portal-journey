...
const Products = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Promotional Banner */}
      <div className="bg-gradient-to-r from-dashboard-primary/90 to-dashboard-primary p-8 rounded-lg shadow-md min-h-[200px] flex items-center">
        <div className="flex items-center gap-6 text-white">
          <Truck className="h-12 w-12" />
          <div className="space-y-3">
            <h2 className="font-semibold text-3xl">Summer Special Offers! 🌞</h2>
